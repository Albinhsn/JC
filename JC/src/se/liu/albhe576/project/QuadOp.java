...
public enum QuadOp {
    ALLOCATE,CMP,JMP, MOV_PRIMARY_TO_SECONDARY_REG,
    MOV_XMM0, MOV_XMM1, MOV_XMM2, MOV_XMM3, MOV_XMM4, MOV_XMM5,
    MOV_R8, MOV_R9, MOV_RDX, MOV_RSI, MOV_RDI, MOV_RCX,
    LOAD_VARIABLE_POINTER, LOAD_FIELD_POINTER, MOVE_STRUCT, MOVE_ARG,
    CONVERT_LONG_TO_DOUBLE, CONVERT_DOUBLE_TO_LONG, CONVERT_DOUBLE_TO_FLOAT, CONVERT_FLOAT_TO_DOUBLE, CONVERT_FLOAT_TO_INT, CONVERT_INT_TO_FLOAT,
    SIGN_EXTEND_BYTE, SIGN_EXTEND_SHORT, SIGN_EXTEND_INT,
    INC,DEC, ADD,SUB, MUL, DIV, SHL, SHR,MOD, IMUL, ADDI, SUBI,

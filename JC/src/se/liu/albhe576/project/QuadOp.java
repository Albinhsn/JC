...
public enum QuadOp {
    JMP, LOAD_MEMBER_POINTER, LOAD_POINTER, CONVERT, PARAM, LOAD_MEMBER, INDEX, DEREFERENCE, JMP_T, JMP_F, ALLOCATE, REFERENCE_INDEX, ASSIGN, ASSIGN_IMMEDIATE, IMUL, CAST,

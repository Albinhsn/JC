...
/**
 * The different types of registers (for x86)
 * @see IntelInstruction
 * @see IntelCodeGenerator
 */
public enum Register {
    ...
    /**
     * The primary general register to be used when generating code for x86
     */
    public static final Register PRIMARY_GENERAL_REGISTER= RAX;
    /**
     * The secondary general register to be used when generating code for x86
     */
    public static final Register SECONDARY_GENERAL_REGISTER= RCX;
    /**
     * The primray streaming simd extension register to be used when generating code for x86
     */
    public static final Register PRIMARY_SSE_REGISTER= XMM0;
    /**
     * The secondary streaming simd extension register to be used when generating code for x86
     */
    ...
    public static Register getMinimumConvertSource(Operation op, DataType source) throws CompileException {
        switch(op){
    ...
    public static Register getMinimumConvertTarget(Operation op, DataType target) throws CompileException {
        switch(op){
